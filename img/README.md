...
```
<p align="left">
  <img src="img/prototype1" width="32%">
  <img src="img/prototype2" width="32%">
  <img src="imgprototype2" width="32%">
</p>
```
...
- 💡An!imated gifs can be used to show animations.     -->
<!-- [alt text](heroshot.jpg) -->
![alt text](heroshot.jpg)
![alt text](<storyboard finale concept.png>)